...
const form = DOM.$throw("form");
const urlInput = DOM.$throw("#url");
const generatedUrlDisplay = DOM.$throw("#generated-url");
...
form.addEventListener("submit", (e) => {
    ...
    if (!end) {
        ...
        const fragmentUrl = fragmentManager.createFragmentURLWithStartAndEnd(start, end);
        generatedUrlDisplay.textContent = fragmentUrl;
    }
    ...
    rangeModel.setEnd(generatedUrlDisplay.firstChild, generatedUrlDisplay.textContent.length);
